                    ...
                    {cartItems.map((item) =>(
                        ...
                        {/* actions */}
                            <div className="flex items-center gap-3 mt-2">
                                {/* decrease(temporary remove) */}
                                <button className="px-3 py-1 border rounded hover:bg-gray-100" onClick={() => dispatch(removeFromCart(item.id))}>
                                    -
                                </button>
                                ...
                                {/* Increase */}
                                <button className="px-3 py-1 border rounded hover:bg-gray-100" onClick={() => dispatch(addToCart(item.id))}>
                                    +
                                </button>
